...
### Prediction Mapping
We can use our `jRip` model on all of the 2016 data, not just the test data, with an accuracy of **93%** (note that there will be some bias due to the fact that the training data is being recycled for the prediction).
