...
We used a rule-based method (`jRip`) to model the 2012 data. Here, our accuracy in predicting county-level outcomes was **85.3%**. We've also listed the rules below.
...
If we train a model and test it with purely 2016 data, our accuracy decreases to 92%.
